 ...
 */
contract ExitFeeHookSafe is BaseHooks, VaultGuard, Ownable, ReentrancyGuardTransient {
    ...
    function onAfterRemoveLiquidity(
        ...
        uint256[] memory,
        bytes memory
    ) public override onlyVault nonReentrant returns (bool, uint256[] memory hookAdjustedAmountsOutRaw) {
